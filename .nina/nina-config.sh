...
# (e.g. "nina --tree --dot" uses TB) but should not invent a
...
# Fill color for a node "nina --orphan --dot" or "nina --dangling
# --dot" draws to call out a problem node. Not used by any of the
